          ...
          {github && (
            <a target="_blank" rel="noreferrer" href={github}>
              <span className="cursor-pointer">
                <Image src={Github} width="30" alt="card-img" height="30" />
              </span>
            </a>
          )}
          {live && (
            <a target="_blank" rel="noreferrer" href={live}>
              <span className="cursor-pointer">
                <Image src={Open} alt="icon" />
              </span>
            </a>
          )}
        </div>
      </div>
      <h4 className="text-aqua-600 font-semiBold pt-2 md:text-center md:mb-1">
        {heading}
      </h4>
      <p className="pr-3 pl-3 font-extralight text-center text-xs pb-10">
        {details}
      </p>
    </div>
  );
