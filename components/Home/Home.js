    ...
    return (
        <>
            <div className={`${slide} index-high h-full pl-10 flex items-start  flex-col justify-center text-white-50 font-poppins font-black text-5xl md:pl-60 md:text-8xl`}>
                ...
                <h3 className="index-high font-medium text-sm md:text-xl  text-gray-850 pt-2">JavaScript <span className="text-aqua-450">/</span> MERN <span className="text-aqua-450">/</span> NextJs <span className="text-aqua-450">/</span> GraphQl <span className="text-aqua-450">/</span> Hasura <span className="text-aqua-450">/</span> Firebase <span className="text-aqua-450">/</span> Tailwind </h3>
